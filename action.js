$(document).ready(function(){
	...
	var work_row = ["<h4><strong>Business analyst at Mokalmat LLC</strong> – (January 2019 – Present)</h4><h5>Responsibilities:</h5><ul><h5><li>Planning and monitoring software agile projects </li></h5><h5><li>Requirements management, communication and analysis</li></h5><h5><li>Part time web developer.</li></h5></ul>",
			"<h4><strong>Software engineer at Mokalmat LLC</strong> – (June 2019 – Present)</h4><h5>Responsibilities:</h5><ul><h5><li>Designing, developing, testing and deploying new features to systems </li></h5></ul>",
    ...
    var frameWorks = ["<div class='row'><div class='col-sm-3'><h5><li>React native (Prior experience)</li></h5></div><div class='col-sm-4'><h5><progress value='70' max='100'></progress></h5></div></div>",
		      "<div class='row'><div class='col-sm-3'><h5><li>Angular 7 (Prior experience)</li></h5></div><div class='col-sm-4'><h5><progress value='60' max='100'></progress></h5></div></div>"];
