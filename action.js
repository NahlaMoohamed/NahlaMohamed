$(document).ready(function(){
	...
	var work_row = ["<h4><strong>Business intelligence developer at ITWorx</strong> – (April 2020 – Present)</h4><h5>Responsibilities:</h5><ul><h5><li>Scripting, developing and designing dashboards using Qliksense by extracting data from multiple sources (QVD files, SQL, Flat files, Excel)</li></h5><h5><li>Troubleshooting and fixing Qlik sense dashboard issues</li></h5><h5><li>Extensive use of set Analysis expressions in the charts for achieving complex logics</li></h5></ul>",
